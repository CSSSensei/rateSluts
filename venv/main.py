...
async def default_photo(message: Message, state: FSMContext):
    ...
    if message.caption:
        ...
        await message.answer(text='Оцени фото, которое ты скинул', reply_markup=get_rates_keyboard(last_num + 1, 0))
